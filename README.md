-- [[ ULTRA RED GLASSMORPHISM - TURBO SPAM & TITLE SYSTEM BY MOILA933 ]] --
...
-- ريموتات الماب الرسمية المستخرجة للسبام والتايتل
...
-- [ الترحيب عند بداية التشغيل الأصلي ]
...
-- [ نظام الإعلان الدوري - يظهر كل دقيقتين ]
task.spawn(function()
    task.wait(2) 
    while true do
